...
@section('content')
    ...
    <div>
        ...
        <div class="bg-secondary">
            <div class="container">
                <div class="flex flex-row py-32 items-center justify-center">
                    <div class="text-white xs:pr-3 lg:pr-20">
                        ...
                        <div class="w-48 pt-10">
                            <a class="block text-color-cucchiara bg-cyan-20 text-center text-base font-body font-bold p-4 rounded mb-0-5">
                                Registros Públicos<br>Cucchiara y Cía. 
                            </a>
                        </div>
                    </div>
                    <div clas="text-center">
                        <a class="block text-color-cucchiara bg-button-reg text-center text-base font-body font-bold p-4 rounded mb-0-5">
