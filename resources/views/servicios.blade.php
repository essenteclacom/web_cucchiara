            ...
            <div class="container xxs:px-20 lg:px-32 xl:px-56">
                <div class="flex flex-row lg:px-40 py-32 items-center justify-center">
                    <div class="text-white xs:pr-3 lg:pr-20">
                        ...
                        <div class="xxs:text-xs xs:text-base sm:text-base text-right max-w-3xl pt-5" >
                            A través de profesionales idóneos te brindamos soluciones de inversión a medida, planteando estrategias que se alineen con tu perfil de riesgo y tus objetivos.
                        </div>
                    </div>
                    <div class="ml-4">
                ...
                <div class="container flex flex-row lg:px-40 py-32 items-center justify-center">
                    <div class="text-white xs:pr-3 lg:pr-20">
                        ...
                        <div class="xxs:text-xs xs:text-base sm:text-base text-right max-w-3xl pt-5">
                            Te damos acceso a todos los mercados argentinos para operar los instrumentos de oferta pública autorizados por la CNV: Títulos públicos, obligaciones negociables, acciones, CEDEARs, fideicomisos financieros, cauciones bursátiles, opciones, futuros, pagarés bursátiles, cheques de pago diferidos, Fondos Comunes de Inversión, etc.
                        </div>
                    </div>
                    <div class="ml-4">
                ...
                <div class="container flex flex-row lg:px-40 py-32 items-center justify-center">
                    ...
                    <div class="text-white xs:pl-3 lg:pl-20">
                        ...
                        <div class="xxs:text-xs xs:text-base sm:text-base text-left max-w-3xl pt-5">
                            Como agente ACDI, te ofrecemos acceso a un amplio abanico de fondos comunes de inversión gestionados activamente por especialistas. Fondos en pesos o en dólares que invierten en instrumentos de renta fija, variable o mixta.
                        </div>
                    </div>
