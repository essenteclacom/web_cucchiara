                ...
                <div class="w-full z-50 top-0 py-3 sm:py-5 relative bg-white justify-center">
                    <div class="container flex items-center justify-between">
                        ...
                        <div class="flex justify-right flex-end flex-row items-center">
                            <a href="/selectaccounttype" class="font-body text-color-cucchiara flex items-center justify-center rounded bg-white button-border-color-primary xxs:text-xs xxs:px-1 xs:px-5 md:px-8 lg:px-8 xxs:py-1 xs:py-2 sm:py-2 md:py-2 lg:py-1 xs:text-base lg:text-base font-bold hover:bg-cyan-20">
                                Open Account
                            </a>
