                ...
                <div class="w-full z-50 top-0 py-3 sm:py-5 relative bg-white justify-center">
                    <div class="container flex items-center justify-between">
                        ...
                        <div class="flex justify-right flex-end flex-row items-center">
                            <a href="/selectaccounttype" class="font-body text-color-cucchiara flex items-center justify-center rounded-md bg-white button-border-color-primary xxs:text-xs xxs:px-1 xs:px-5 md:px-8 lg:px-8 xxs:py-1 xs:py-2 sm:py-2 md:py-2 lg:py-1 xs:text-base lg:text-base font-bold hover:bg-cyan-20">
                                Open Account
                            </a>
                            <a href="/login" class="font-body ml-1 text-color-cucchiara flex items-center justify-center rounded-md bg-cyan-20 button-border-color xxs:text-xs xxs:px-1 xs:px-5 md:px-8 lg:px-8 xxs:py-1 xs:py-2 sm:py-2 md:py-2 lg:py-1 xs:text-base lg:text-base font-bold hover:bg-white">
                                Log in
                            </a>
                                    ...
                                    <li class="text-color-cucchiara group pl-6">
                                        ...
                                        <ul>
                                            <li class="text-color-cucchiara text-base font-bold uppercase w-20">
                                                <a class="hover:bg-cyan-20 flex items-center justify-center rounded-md pr-41-custom py-1 pl-4 bg-white" href="/esp">
                                                    ESP
                                                </a>
                                            </li>
                                        </ul>
                        ...
                        <form class="mx-auto w-full pt-10" action="/contact" method="POST" role="form">
                            ...
                            <div class="flex xxs:flex-col xs:flex-col sm:flex-row md:flex-row lg:flex-row items-start justify-center">
                                <div class="flex flex-col md:flex-col xxs:w-full mr-4">
                                    <input class="w-full rounded border-white py-5 font-body text-grey-custom" placeholder="First name and Last name*" type="text" name="name" id="name"/>
