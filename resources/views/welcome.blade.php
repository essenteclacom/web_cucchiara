  ...
  >
    <div class="group rounded px-8 py-12 shadow hover:bg-primary">
      <div class="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
        <div class="hidden group-hover:block">
          <img
            src="{{ asset('/img/icon-development-white.svg') }}"
            alt="development icon"
          />
        </div>
        <div class="block group-hover:hidden">
          <img
            src="{{ asset('/img/icon-development-black.svg') }}"
            alt="development icon"
          />
        </div>
      </div>
    ...
    <div class="group rounded px-8 py-12 shadow hover:bg-primary">
      <div class="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
        <div class="hidden group-hover:block">
          <img
            src="{{ asset('/img/icon-content-white.svg') }}"
            alt="content marketing icon"
          />
        </div>
        <div class="block group-hover:hidden">
          <img
            src="{{ asset('/img/icon-content-black.svg') }}"
            alt="content marketing icon"
          />
        </div>
      </div>
    ...
    <div class="group rounded px-8 py-12 shadow hover:bg-primary">
      <div class="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
        <div class="hidden group-hover:block">
          <img
            src="{{ asset('/img/icon-mobile-white.svg') }}"
            alt="Mobile Application icon"
          />
        </div>
        <div class="block group-hover:hidden">
          <img
            src="{{ asset('/img/icon-mobile-black.svg') }}"
            alt="Mobile Application icon"
          />
        </div>
      </div>
    ...
    <div class="group rounded px-8 py-12 shadow hover:bg-primary">
      <div class="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
        <div class="hidden group-hover:block">
          <img
            src="{{ asset('/img/icon-email-white.svg') }}"
            alt="Email Marketing icon"
          />
        </div>
        <div class="block group-hover:hidden">
          <img
            src="{{ asset('/img/icon-email-black.svg') }}"
            alt="Email Marketing icon"
          />
        </div>
      </div>
    ...
    <div class="group rounded px-8 py-12 shadow hover:bg-primary">
      <div class="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
        <div class="hidden group-hover:block">
          <img
            src="{{ asset('/img/icon-design-white.svg') }}"
            alt="Theme Design icon"
          />
        </div>
        <div class="block group-hover:hidden">
          <img
            src="{{ asset('/img/icon-design-black.svg') }}"
            alt="Theme Design icon"
          />
        </div>
      </div>
    ...
    <div class="group rounded px-8 py-12 shadow hover:bg-primary">
      <div class="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
        <div class="hidden group-hover:block">
          <img
            src="{{ asset('/img/icon-graphics-white.svg') }}"
            alt="Graphic Design icon"
          />
        </div>
        <div class="block group-hover:hidden">
          <img
            src="{{ asset('/img/icon-graphics-black.svg') }}"
            alt="Graphic Design icon"
          />
        </div>
      </div>
